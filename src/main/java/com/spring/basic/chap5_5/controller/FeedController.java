...
//    }
    ...
    public ResponseEntity<?> feedList() {
        ...
        List<FeedListResponse> feedListResponses = feedService.listProcess();

        return ResponseEntity.ok().body(feedListResponses);
    }
    ...
    public ResponseEntity<?> deleteFeed(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.ok("피드 삭제 성공! 삭제 id: " + id);
